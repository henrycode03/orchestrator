...
class OpenClawExecutor:
    ...
    async def monitor_session(self, session_key: str, task_id: str,
                             update_interval: float = 5.0) -> Dict[str, Any]:
        """
    ...
    async def _update_task_with_session(self, task_id: str, 
    ...
    async def _update_task_progress(self, task_id: str, 
                                   output: str, usage: Dict, model: str):
