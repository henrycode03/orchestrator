...
AUDIT_SURFACES: tuple[AuditSurface, ...] = (
    ...
    AuditSurface(
        ...
        emitted_by=("app/runtime_naming.py",),
        read_by=(
    ...
    AuditSurface(
        ...
        recommended_action="Old rejection detail field removed in Phase 11U; keep historical fixture readers on architecture output.",
        reader_policy="Current regression coverage asserts architecture diagnostics.",
        write_status="compatibility_write_removed_phase11u",
        required_tokens=(
    ...
    AuditSurface(
        ...
        recommended_action="Old parsed-shape detail field removed in Phase 11U; keep architecture diagnostics.",
        reader_policy="Current regression coverage asserts architecture diagnostics.",
        write_status="compatibility_write_removed_phase11u",
        required_tokens=(
    ...
    AuditSurface(
        ...
        removal_risk="Medium for diagnostics and fixtures.",
        recommended_action="Old raw-output excerpt detail field removed in Phase 11U; keep architecture diagnostics.",
        reader_policy="Current regression coverage asserts architecture diagnostics.",
        write_status="compatibility_write_removed_phase11u",
        required_tokens=(
    ...
    AuditSurface(
        ...
        recommended_action="Old invalid-output reason removed in Phase 11U; use architecture reason directly.",
        reader_policy="Current regression coverage asserts architecture reason metadata.",
        write_status="compatibility_write_removed_phase11u",
        required_tokens=(
    ...
    AuditSurface(
        ...
        recommended_action="Old stale-replace reason removed in Phase 11U; use architecture reason directly.",
        reader_policy="Current regression coverage asserts architecture reason metadata.",
        write_status="compatibility_write_removed_phase11u",
        required_tokens=(
    ...
    AuditSurface(
        ...
        recommended_action="Old correction marker removed in Phase 11U; keep architecture correction marker.",
        reader_policy="Current regression coverage asserts architecture correction metadata.",
        write_status="compatibility_write_removed_phase11u",
        required_tokens=(
