"""One corrected neutral OpenClaw identity probe for POST33-RUNTIME2."""
...
EVIDENCE_ROOT = REPOSITORY_ROOT / "docs/roadmap/reports/evidence/post33-runtime2"
...
def main() -> int:
    ...
    runtime_workspace = Path(tempfile.mkdtemp(prefix="post33-runtime2-probe-"))
    service = None
    ...
    try:
        ...
        command = service.build_cli_agent_command(
            ...
            source_brain="local",
            timeout_seconds=120,
            session_prefix="runtime2-identity-probe",
        ...
        proc, diagnostics = asyncio.run(
            service._run_cli_prompt_with_diagnostics(
                ...
                prompt=PROMPT,
                invocation_kind="runtime2-identity-probe",
                strict_provider_result=False,
            )
        )
    ...
    _write_json(PROBE_ROOT / "corrected-identity-probe.json", payload)
    return exit_status
